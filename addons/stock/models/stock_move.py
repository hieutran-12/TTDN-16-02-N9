        ...
        for neg_move in neg_qty_moves:
            ...
            for pos_move in moves_by_neg_key.get(neg_key(neg_move), []):
                ...
                if float_compare(pos_move.price_unit, neg_move.price_unit, precision_digits=rounding) == 0:
                    new_tong_gia_tri = pos_move.product_qty * pos_move.price_unit + neg_move.product_qty * neg_move.price_unit
                    ...
                    if float_compare(pos_move.product_uom_qty, abs(neg_move.product_uom_qty), precision_rounding=pos_move.product_uom.rounding) >= 0:
                        ...
                        pos_move.write({
                            'price_unit': float_round(new_tong_gia_tri / pos_move.product_qty, precision_digits=price_unit_prec) if pos_move.product_qty else 0,
                    ...
                    neg_move.price_unit = float_round(new_tong_gia_tri / neg_move.product_qty, precision_digits=price_unit_prec)
